...
Hooks.on("renderActorDirectory", (_app, html) => {
    if (game.user.isGM) {
        ...
        function nameGenerator() {
            let f = first[Math.floor((Math.random() * first.length))]
            let l = last[Math.floor((Math.random() * last.length))]
            name = f.concat(" ", l);
            return name;
        };
        ...
        random.on("click", (ev) => {
            ...
            // Race
            let charRace = listRandom(raceList);
            // Career
            ...
            let skillsTotal = 0;
            for (var i = 0; i < 3; i++) {
                skillsTotal += rollCareerSkills(careerList[charCareer]["keySkills"][i]);
            };

            for (var s in skillList) {
                if (skillsTotal < 10) {
                    skillsTotal += rollSkills(s);
                } else {
                    skillsTotal += 0;
                    skillList[s]["value"] += 0;
                }
                ...
                system: {
                    ...
                    "skills" : {
                      "closeCbt" : {
                         "ability" : "str",
                         "label" : "Close Combat",
                         "value" : skillList["closeCbt"]["value"]
                      },
                      "command" : {
                         "ability" : "emp",
                         "label" : "Command",
                         "value" : skillList["command"]["value"]
                      },
                      "comtech" : {
                         "ability" : "wit",
                         "label" : "Comtech",
                         "value" : skillList["comtech"]["value"]
                      },
                      "heavyMach" : {
                         "ability" : "str",
                         "label" : "Heavy Machinery",
                         "value" : skillList["heavyMach"]["value"]
                      },
                      "manipulation" : {
                         "ability" : "emp",
                         "label" : "Manipulation",
                         "value" : skillList["manipulation"]["value"]
                      },
                      "medicalAid" : {
                         "ability" : "emp",
                         "label" : "Medical Aid",
                         "value" : skillList["medicalAid"]["value"]
                      },
                      "mobility" : {
                         "ability" : "agl",
                         "label" : "Mobility",
                         "value" : skillList["mobility"]["value"]
                      },
                      "observation" : {
                         "ability" : "wit",
                         "label" : "Observation",
                         "value" : skillList["observation"]["value"]
                      },
                      "piloting" : {
                         "ability" : "agl",
                         "label" : "Piloting",
                         "value" : skillList["piloting"]["value"]
                      },
                      "rangedCbt" : {
                         "ability" : "agl",
                         "label" : "Ranged Combat",
                         "value" : skillList["rangedCbt"]["value"]
                      },
                      "stamina" : {
                         "ability" : "str",
                         "label" : "Stamina",
                         "value" : skillList["stamina"]["value"]
                      },
                      "survival" : {
                         "ability" : "wit",
                         "label" : "Survival",
                         "value" : skillList["survival"]["value"]
                      }
                   },
                    "general": {
                        "career": {
